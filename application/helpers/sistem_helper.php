...
{
	function ambil_nilai_kriteria($pinjamanID,$dari,$tujuan)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
...
{
	function ambil_nilai_subkriteria($pinjamanID,$kriteriaid,$dari,$tujuan)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
...
{
	function ambil_prioritas($pinjamanID,$subkriteriaID)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
